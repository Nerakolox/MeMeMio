...
| 合流后的浏览页在 390×844 **视口**下走一遍：搜索框落点、三块 `Notice`、`BrowseFilterSheet` 抽屉与 `q` 的关系（窄屏换的只是筛选列，列表是同一棵——**没验，不是没长**） | [检索与筛选合流](../_archive/joint-tasks/2026-09-26-检索筛选合一.md) §8 遗留 1 |
